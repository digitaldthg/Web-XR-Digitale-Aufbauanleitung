...
import { AmbientLight,MeshBasicMaterial,SpotLight, DirectionalLight } from 'three';
...
// this.webXRScene.Scene.add( light );
...
// light.shadow.camera.far = 500; // default
    ...
    this.webXRScene.Loader.loadStack({
      ...
      Object.keys(library).map((elements, index)=>{
       ...
       // console.log(library[elements]);
        ...
        //library[elements].mixer = new THREE.AnimationMixer();
  ...
  PlayActionByName(clipName){
   ...
   // console.log("PlayActionByName" , this.library.VorhangSchiene ,this.library, clipName, this.library, MaskPositions[clipName]);
  ...
  ChangeAnimationStep(dir){
    ...
    //console.log(this.steps, this.steps[nextStep], nextStep);
