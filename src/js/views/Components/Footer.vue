...
export default {
  ...
  methods:{
    ...
    playClip(clipName){
      ...
      this.title = this.$store.state.MaskPositions[clipName].Title;
      this.text =  this.$store.state.MaskPositions[clipName].Description;

      this.toolsNeeded = this.filterTools( this.$store.state.MaskPositions[clipName]);
